...
BIN_NAVI:=navi
OBJ_NAVI:=src/navi.o src/list.o src/parser.o src/url.o src/resource.o src/pool.o src/view.o src/style.o src/nvg.o src/nvg_gl.o src/fons.o src/render.o src/widgets.o src/history.o
